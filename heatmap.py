...
def get_params():
    params = {
        'weight': 'runs/train/exp109/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'GradCAMPlusPlus', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': [10, 12, 14, 16, 18],  # YOLOv8s exp109
        # 'layer': [14, 17, 20, 23, 26],  # WeedsDetectNet exp157
        # 'layer': [11, 13, 15, 17, 19],  # YOLOv8s-CBAM-C3Ghost exp378
        'backward_type': 'all', # class, box, all
        'conf_threshold': 0.15, # 0.45 0.2   0.6
        'ratio': 0.03, # 0.02-0.1
        'show_box': True,
        'renormalize': True
        # 'show_box': False,
...
if __name__ == '__main__':
    ...
    model(r'/home/ge107552201346/datasets/test/detect', 'result')
    # model(r'/home/ge107552201346/datasets/test/WeedsDetectNet', 'result')